...
var Model = Fiber.extend( function(){
  ...
  return {
    init: function( data, settings ) {
      ...
      uuid = new Date().getTime().toString( 36 ) + Math.floor( Math.random() * 1e14 );
    ...
    /**
     * Filters the object to only have the white-listed keys
     * @method
     * @public
    ...
    /**
     * Filters the object to only exclude the back listed keys
     * @method
     * @public
